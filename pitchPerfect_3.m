function pitchPerfect_3()

  pkg load signal

  disp("Welcome to Pitch Perfect Level 3")
  ...
  while in == "repeat"
    ...
    disp("accepted inputs - C, D, E, F, G, A, B")
    disp("enter 'repeat' to repeat the note") 
    in = input("what note was this???: ", "s")
  ...
  disp("input was: ")
  disp(in)
  disp("actual note was: ")
  disp(notes(n))
  
  if(in == notes(n))
    disp("well done u bitch")
  else
    disp("keep trying bro")
  endif
